...
export class AutoGeneratedMigration1731611606465 implements MigrationInterface {
    name = 'AutoGeneratedMigration1731611606465'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "userToRole" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "assignedAt" TIMESTAMP NOT NULL DEFAULT now(), "roleId" uuid, "userId" uuid, CONSTRAINT "PK_237d09ee0e67dca5682c3f4fd77" PRIMARY KEY ("id"))`);
